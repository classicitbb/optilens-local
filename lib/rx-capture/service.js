...
function createRxCaptureService(dependencies = {}) {
    ...
    const result = await pool.request()
      ...
      .query(`
        SELECT capture_order_id, status, created_by_user_id, created_by_username,
          ...
          source_image_deleted_at, extracted_json, validated_json, created_at,
  ...
  return { createOrder, getOrder, listOrders, processOrder, reprocessOrder, updateOrder };
}
