...
USING (VALUES
    ...
    (N'skylab-shipped', N'SKYLAB', N'SkyLab Optical', N'ymartinez@skylab-optical.net', NULL, N'CONTAINS', N'SHIPPING DOCUMENTS', N'SKYLAB_SHIPPED', N'SkyLabShippedPdfParser', N'customer_order_reference', N'.pdf', N'SkyLab PDF text parser confirmed Rx No and explicit Stock/Rx rows; confirm operational reference mapping before enabling.' )
