...
function createRxCaptureService(dependencies = {}) {
  ...
  return { approveOrder, createOrder, getApprovalOrder, getOrder, listApprovalQueue, listOrders, processOrder, reprocessOrder, saveResolution, stageOrder, suggestAlias, updateOrder };
}
