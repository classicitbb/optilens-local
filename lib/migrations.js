...
const migrationFiles = [
  ...
  "041-supplier-exception-digests.sql",
  "042-chemistry-clip-module.sql",
  "043-rx-capture.sql",
  "044-rx-capture-milestone-2.sql",
  "045-rx-capture-review-workflow.sql",
  "046-rx-capture-milestone-4-release.sql",
  "047-file-drop-destinations.sql",
  "048-rx-capture-innovations-account-mappings.sql",
  "049-rx-capture-voice-input.sql"
];
