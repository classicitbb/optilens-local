...
//
// catalog_type / row_type are CLOSED sets on the CV side — the catalog editor,
// the portal RPC (portal_assigned_pricelist_catalog) and generateCatalogPdf all
// switch on 'rx' | 'stock' | 'buysell' and 'lens' | 'addon' | 'supply'
// respectively. Publishing anything else writes rows that are never rendered.
