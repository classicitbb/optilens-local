...
const { functionsBase } = require('./innovations-sync');
...
class LiveGatewayWorker {
  ...
  async post(body) {
    ...
    const response = await fetch(`${functionsBase(this.creds.baseUrl)}/live-data-gateway`, {
      method: 'POST',
...
module.exports = new LiveGatewayWorker();
