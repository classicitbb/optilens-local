...
const ENTITIES = {
  ...
  contacts: {
    sql: `
      SELECT ContactID, CustomerID, FirstName, LastName, Email, PhoneNumber
      FROM dbo.Contacts
      ORDER BY ContactID
    `,
    map: (r) => ({
...
module.exports = { sync, readEntity, functionsBase, ENTITIES, fetchNextRequest, completeRequest, runRequested };
