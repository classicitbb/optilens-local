...
const { readMailbox } = require("./imap-mailbox");
...
module.exports = { ALLOWED_STATUSES, MAX_FIXTURE_BYTES, createAttachment, createEvent, createFixtureWorkflow, decideAction, idempotencyKey, listActions, listExceptions, listMailboxReconciliation, listOperations, listSupplierRules, resolveException, sha256, validateFixture };
