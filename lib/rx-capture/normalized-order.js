...
const TEXT_LENS_FIELDS = ["materialGroup", "lensType", "design", "material", "option", "coating", "coatingSku", "catalogAlias"];
...
function emptyNormalizedOrder() {
  return {
    ...
    lensRequest: { materialGroup: null, lensType: null, design: null, material: null, option: null, coating: null, coatingSku: null, catalogAlias: null },
    instructions: null,
    uncertainFields: [],
    missingFields: []
  };
