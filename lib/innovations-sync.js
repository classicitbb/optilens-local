...
async function receiverVersion(base) {
  try {
    const res = await fetch(`${base}/innovations-sync/version`);
...
module.exports = { sync, readEntity, describeTables, functionsBase, receiverVersion, statementWindowClause, STATEMENT_WINDOW_MONTHS, ENTITIES, ENTITY_ORDER, normalizeEntitySelection, fetchNextRequest, completeRequest, runRequested };
