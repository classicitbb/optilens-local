...
const TRENDS_GLOSSARY = {
  addChannels:
    ...
    + "actually pulled from stock (RxArchive joined to LensItem.Add_Cyl). STOCK SOLD = adds invoiced on stock orders "
    + "(OrderType 3/9). HELD = the add mix on the shelf right now, a position rather than a series.",
  addShare:
