...
USING (VALUES
    (N'tog-wip', N'TOG', N'Thai Optical Group', N'noreply-system@thaiopticalgroup.com', NULL, N'CONTAINS', N'WIP Report Classic', N'TOG_WIP', N'TOGXlsxParser', N'customer_order_reference', N'.xlsx', N'TOG tray/order reference requires sample confirmation.'),
    (N'tog-dispatch', N'TOG', N'Thai Optical Group', N'noreply-system@thaiopticalgroup.com', NULL, N'CONTAINS', N'Report Dispatch Classic', N'TOG_DISPATCH', N'TOGXlsxParser', N'customer_order_reference', N'.xlsx', N'TOG tray/order reference requires sample confirmation.'),
    (N'skylab-shipped', N'SKYLAB', N'SkyLab Optical', N'ymartinez@skylab-optical.net', NULL, N'CONTAINS', N'SHIPPING DOCUMENTS', N'SKYLAB_SHIPPED', N'SkyLabShippedPdfParser', N'customer_order_reference', N'.pdf', N'SkyLab Rx No mapping requires sample confirmation; stock rows must be excluded.' )
